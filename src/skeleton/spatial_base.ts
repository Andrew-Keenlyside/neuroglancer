...
/**
 * Frontend/backend shared contract for the spatially-indexed skeleton source.
 *
 * Kept out of `base.ts` so that file stays byte-identical to upstream: every
 * symbol here is fork-only, and none of it has an upstream consumer.
 */
